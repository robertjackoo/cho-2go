...
const UUID = process.env.UUID || 'f21668ee-ba31-4569-b38f-0acd80276bf9'; //若需要改UUID，需要在config.json里改为一致
...
const NEZHA_KEY = process.env.NEZHA_KEY || 'ZRHbQhbmIE33NtCQgt';
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'cho.vriggqv.eu.org';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiZTg2NTkyZDg0NDIxYTBhMGU3MGVlZTM5YzBjNTcwNmIiLCJ0IjoiMDdjZjFkYzQtYzA2OC00MDc5LWI5MjUtMTQ1MWM5YTM3YThhIiwicyI6Ik9UbGhNVGczWkRJdFpUQXdaQzAwTldRNExUbGxPR1l0WXpGak56Z3lPVGhtTlRrdyJ9';
